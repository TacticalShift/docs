...
При помощи Helper создайте файл брифинга и замените им файл ^tSF_briefing.sqf^. О требованиях к брифингу читайте [тут](https://tacticalshift.ru/docs/MMO/mission_making_missions_editor_requirements.html).
